...
package com.zhangchong.libnetwork.Core.Dispatch;
 ...
 * specified {@link NetworkExcutor} interface. Responses are committed to cache, if
...
public class NetworkDispatcher extends Thread {
    ...
    public NetworkDispatcher(BlockingQueue<Request> queue,
            NetworkExcutor network, Cache cache,
    ...
    private void parseAndDeliverNetworkError(Request<?> request, NetException error) {
