...
package com.zhangchong.libnetwork.Tools.Request;

import com.zhangchong.libnetwork.Core.DefaultRetryPolicy;
...
public class ImageRequest extends Request<Bitmap> {
    ...
    public Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        ...
        synchronized (sDecodeLock) {
            try {
                ...
                NetLog.e("Caught OOM for %d byte image, url=%s", response.data.length, getUrl());
    ...
    private Response<Bitmap> doParse(NetworkResponse response) {
        ...
        if (bitmap == null) {
            return Response.error(new ParseException());
        } else {
